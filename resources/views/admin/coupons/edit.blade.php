...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <form action="{{ route('coupons.update',$coupon->id) }}" id="form_validation" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            <input type="text" name="coupon_code" value="{{ $coupon->coupon_code  }}"  class="form-control" placeholder="Coupon Code.?">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            <input type="number" name="amount" value="{{ $coupon->amount  }}"  class="form-control" placeholder="Amount.?">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="form-line">
                                            <input type="date"   name="expire_date" value="{{ $coupon->expire_date  }}"   class="form-control datetime" placeholder="Ex: 30/07/2016 23:59">
                                        </div>
                                    </div>
                                </div>
