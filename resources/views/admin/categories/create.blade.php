...
<section class="content">
      <div class="container-fluid">
          ...
          <form action="{{ route('categories.store') }}" id="form_validation" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-line">
                                            <label for="parent">LEVEL</label>
                                                <select name="parent"   class="form-control">
                                                    <option value="0" {{ old('parent') == 0 ? 'selected' : ''  }}> Main Category ... </option>
