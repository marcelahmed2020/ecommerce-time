            ...
            <div class="row">
              ...
              <div class="col-md-6">
                  <ol class="breadcrumb breadcrumb-bg-black">
                      ...
                      <li class="active"> <a href="#" class="font_l">  Currencies </a></li>
                                          </ol>
              ...
              <div class="card">
                                      <div class="header">
                                          ...
                                          <h2>
                                              ...
                                              <a  href="{{ route('currencies.create')}}"  title=""  class="btn btn-primary"> <i class="material-icons">plus_one</i> ADD Currencies</a>
                                                                            ...
                                                                            @foreach($currencies as $key => $cat)
                                                                              <tr>
                                                                                  ...
                                                                                  @permission('update_categories')
                                                                                     <a class="btn btn-info btn-sm" href="{{ route('currencies.edit',$cat->id)  }}" title="Edit"> <i class="material-icons">mode_edit</i>  </a>
                                                                                       @endpermission

                                                                                  @permission('delete_categories')
                                                                                      <form   style="margin:0px 2px  ;display:inline"
                                                                                       action="{{ route('currencies.destroy',$cat->id)  }}" id="date-form-currencies-{{ $cat->id}}"
                                                                                       method="post">
                                                                                     {{ csrf_field() }}
                                                                                          {{ method_field('DELETE') }}
                                                                                     </form>
                                                                                   ...
                                                                                   }"  href="{{ route('currencies.destroy',$cat->id)  }}"><i class="material-icons">delete</i>   </a>
                                                                                  @endpermission
                                                                                    </td>
                                                                              </tr>
                                                                              @endforeach
