...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <form action="{{ route('currencies.update',$currency->id) }}" id="form_validation" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            <input type="text" name="symbol" value="{{ $currency->symbol  }}"  class="form-control" placeholder="Currency Symbol.?">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            <input type="text" name="exchange_rate" value="{{ $currency->exchange_rate  }}"  class="form-control" placeholder="Currency Exchange Rate .?">
