...
<section class="content">
                                        ...
                                        @foreach($admin->tag as $key => $tag)
                                            <div class="panel panel-default panel-post">
                                                <div class="panel-heading">
                                                    <div class="media">
                                                        <div class="media-body">
                                                            ...
                                                            Created Tag  <b class="pull-right">  {{ $tag->created_at }}</b>
                                                            @if($tag->edit != 0)
                                                                <br>
                                                                Edit By  {{$tag->editor->first_name}} {{$tag->editor->last_name}}  <b class="pull-right"> {{ $tag->updated_at }}
                                                                </b>@endif
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="panel-body">
                                                    <div class="post">
                                                        <div class="post-heading">
                                                            <p><a href="{{  route('tag.index')}}?id={{$tag->id}}">  Name : {{ $tag->name }}</a></p>
                                                            <p>short Description  : {{ $tag->short_desc }}</p>
                                                        </div>
    ...
    {{--                                    Cms Page Or Police --}}
                                        ...
                                        @foreach($admin->cms as $key => $cms)
                                            <div class="panel panel-default panel-post">
                                                <div class="panel-heading">
                                                    <div class="media">
                                                        <div class="media-body">
                                                            ...
                                                            Created Police  <b class="pull-right">  {{ $cms->created_at }}</b>
                                                            @if($cms->edit != 0)
                                                                <br>
                                                                Edit By  {{$cms->editor->first_name}} {{$cms->editor->last_name}}  <b class="pull-right"> {{ $cms->updated_at }}
                                                                </b>@endif
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="panel-body">
                                                    <div class="post">
                                                        <div class="post-heading">
                                                            <p><a href="{{  route('cms.index')}}?id={{$cms->id}}">  title : {{ $cms->title }}</a></p>
                                    ...
                                    @endif
{{--                                     Coupons --}}
                                    @if(! empty($admin->coupon))
                                        @foreach($admin->coupon as $key => $cms)
                                            <div class="panel panel-default panel-post">
                                                <div class="panel-heading">
                                                    <div class="media">
                                                        <div class="media-body">
                                                            ...
                                                            Created Pincodes  <b class="pull-right">  {{ $cms->created_at }}</b>
                                                            @if($cms->edit != 0)
                                                                <br>
                                                                Edit By  {{$cms->editor->first_name}} {{$cms->editor->last_name}}  <b class="pull-right"> {{ $cms->updated_at }}
                                                                </b>@endif
                                                ...
                                                <div class="panel-body">
                                                    <div class="post">
                                                        <div class="post-heading">
                                                            <p><a href="{{  route('coupons.index')}}?id={{$cms->id}}">  Coupon Code : {{ $cms->coupon_code }}</a></p>
                                                            <p> Amount type  : {{ $cms->amount_type }}</p>
                                                        </div>
...
{{--                                     Pincodes --}}
                                    @if(! empty($admin->pincodes))
                                        @foreach($admin->pincodes as $key => $cms)
                                            <div class="panel panel-default panel-post">
                                                <div class="panel-heading">
                                                    <div class="media">
                                                        <div class="media-body">
                                                ...
                                                <div class="panel-body">
                                                    <div class="post">
                                                        <div class="post-heading">
                                                            <p><a href="{{  route('pincodes.index')}}?id={{$cms->id}}">  City : {{ $cms->city }}</a></p>
                                                            <p> pincodes: {{ $cms->pincodes }}</p>
                                                            <p> address: {{ $cms->address }}</p>
                                                        </div>
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="change_password_settings">
                                    <form class="form-horizontal"  action="{{ route('admin.update_info',$admin->id) }}" method="post" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                        {{ method_field('put') }}
                                        <div class="form-group">
