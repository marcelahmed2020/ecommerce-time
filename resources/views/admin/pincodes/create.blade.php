...
<section class="content">
      <div class="container-fluid">
          ...
          <form action="{{ route('pincodes.store') }}" id="form_validation" method="post" enctype="multipart/form-data">
                                           ...
                                           <div class="col-sm-6">
                                               <div class="form-group">
                                                   <div class="form-line">
                                                       ...
                                                       <input type="text" name="pincodes" value="{{ old('pincodes')  }}"  class="form-control" placeholder="Pincodes.?">
