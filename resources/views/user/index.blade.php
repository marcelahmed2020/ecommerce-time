        ...
        <div class="shop-bar-area">
            <div class="shop-bar pb-60">
                <div class="shop-found-selector">
                    <div class="shop-found">
                        <p><span>{{$products_saa->count()}}</span> Product Found of <span>{{$products->count()}}</span></p>
                    </div>
                    <div class="shop-selector">
                        <label>Sort By : </label>
                        <select name="select"  id="navigation">
                             <option value="{{url('?Asc')}}">A to Z</option>
                            <option value="{{url('?Desc')}}"> Z to A</option>
                        </select>
            ...
            <div class="shop-product-content tab-content">
                ...
                <div id="grid-sidebar12" class="tab-pane fade active show">
                    <div class="row">
                         @foreach($products_saa as $product)
                            ...
                            <div class="product-wrapper mb-30 single-product-list product-list-right-pr mb-60">
                                ...
                                <div class="product-content-list">
                                    <div class="product-list-info">
                                        <h4><a href="{{route('details',$product->id)}}">{{$product->title}}</a></h4>
                                        <span>$ {{$product->price}}</span>
                                        <p>{{$product->short_desc}}. </p>
                                        <p>   <div class="top-rated-text">
...
{{--                                    <span class="old">$120.00  </span>--}}
                                ...
                                <div class="quickview-plus-minus">
                                    ...
                                    <div class="quickview-btn-wishlist">
                                      ...
                                      <br>
                                        <a class="btn-hover" href="{{url('/product/details/'.$product->id)}}">More Details</a>
                                    </div>
